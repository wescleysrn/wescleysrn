...
My name is Wescley de Macêdo Sousa, I work as a Software Engineer Specializing in Java, Angular and Cloud Native Microservices Architecture, but I'm an enthusiast and passionate about technology, so I'm always learning something new. <br>
With 13 years of experience, strong interpersonal and communication skills, self-motivated with a positive attitude.

# 🚀 Expertise

Experienced with all stages of the software development life cycle (SDLC), various CI/CD systems and build tools (ant, maven, gradle, etc.), software development, RESTful web services, OAuth2, agile methodologies and the main Java web development frameworks such as Spring Boot, Hibernate, JPA. With knowledge in database technologies such as MySQL, Oracle or PostgreSQL, also in non-relational databases such as MongoDB, Neo4J, Cassandra. Strong background in programming HTML, CSS, TypeScript, experience working with XML, XSLT, XPath, JSON, serverless technologies, Amazon Web Services (AWS), familiar with Git, Jenkins, BitBucket, Jira.
